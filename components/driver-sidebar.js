...
const navItems = [
    ...
    { name: "My Trips", icon: Car, path: "/my-trips" },
...
export default function Sidebar({ sidebarOpen, setSidebarOpen }) {
    ...
    return (
        <>
            <aside
                className={`fixed lg:sticky top-0 h-screen w-72 bg-slate-950 text-slate-300 flex flex-col z-40 transition-transform duration-300 ${
